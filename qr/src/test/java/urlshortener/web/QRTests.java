...
public class QRTests {
  ...
  @Test
  public void thatControllerCreatesACorrectQR() throws Exception {

    ByteArrayOutputStream oos = new ByteArrayOutputStream();
    QRCode.from("something/f684a3c4").writeTo(oos);
...
>>>>>>> f1bdf91aad4197e51f0ab27a9a18a173b51c0148
  ...
  private void configureSaveQR() throws InterruptedException, ExecutionException, URISyntaxException{
    when(qrService.createQR(any(), any()))
        ...
        CompletableFuture.completedFuture(new QR("f684a3c4", URI.create("something/f684a3c4"), qr1().getQR())));
  }
